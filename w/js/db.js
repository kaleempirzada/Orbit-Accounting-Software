...
function getGitHubConfig() {
    const localConfig = localStorage.getItem(GITHUB_CONFIG_KEY);
    if (localConfig) {
        return JSON.parse(localConfig);
    }
    
    // Hardcoded fallback configuration as requested
    // WARNING: If your repository is PUBLIC, GitHub will automatically revoke this token 
    // the moment you push this file to GitHub for security reasons.
    return {
        owner: 'kaleem-pirzada',
        repo: 'Orbit-Accounting-Software',
        token: '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'
    };
}
